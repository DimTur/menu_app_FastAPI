...
class DatabaseUpdater:
    ...
    async def add_new_menu(self, menu_data):
        menu_item = Menu(
    ...
    async def add_new_submenu(self, submenu_data, menu):
    ...
    async def add_new_dish(self, dish_data, submenu):
        dish_item = Dish(
    ...
    async def remove_menu_if_not_in_data(self, full_base):
    ...
    async def remove_submenu_if_not_in_data(self, menu, submenus_data):
    ...
    async def remove_dish_if_not_in_data(self, submenu, dishes_data):
